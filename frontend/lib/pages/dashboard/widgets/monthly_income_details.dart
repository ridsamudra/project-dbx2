...
class _MonthlyIncomeDetailsState extends State<MonthlyIncomeDetails> {
  ...
  Future<void> fetchMonthlyIncomeData() async {
    ...
    try {
      ...
      final uri =
          Uri.parse('http://127.0.0.1:8000/api/revenuedetails/filterbymonths/')
      ...
      if (response.statusCode == 200) {
        ...
        if (data is Map<String, dynamic> && data[widget.location] != null) {
          ...
          setState(() {
            monthlyIncomeData = List<Map<String, dynamic>>.from(
                locationData.where((item) => item['bulan'] != null));
  ...
  Widget _buildMultiLineChart() {
    ...
    LineSeries<Map<String, dynamic>, String> createSeries(
      ...
      return LineSeries<Map<String, dynamic>, String>(
        name: name,
        dataSource: monthlyIncomeData,
        xValueMapper: (Map<String, dynamic> data, _) =>
            _getMonthAbbreviation(data['bulan']),
  ...
  String _getMonthAbbreviation(dynamic month) {
